...
export default class Colonoscopy extends React.Component {
    ...
    componentWillMount(){
     ...
     getCategoryFromServer(){
        console.log("inside getCategoryFromServer111")
        const {getCategoryIfobtFromServer} = this.props
        return getCategoryIfobtFromServer()
     }
            ...
            >
                ...
                <Wizard.Page>
                 ...
                 <Wizard.Page>
                     ...
                     <SympSwitch symptom ={this.state.symptom} getCategoryFromServer={this.state.getCategoryFromServer}/>
