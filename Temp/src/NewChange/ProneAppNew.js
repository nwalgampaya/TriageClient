...
export default class ProneApp extends Component {
  ...
  createSpecificComp = () => {
    console.log("in createSpecificComp")
        ...
        <div>
          ...
          <div class="row">
            ...
            <div className="col-sm-2">
              ...
              <select className="form-control dorp-box" id="idCompType" value={this.state.complaintType} name="complaintTypecolumn">                            {
          ...
          <div class="row">
            ...
            <div className="col-sm-6">
              ...
              <select className="form-control dorp-box" id="idSpecComp" value={this.state.specificComplaint} name="specificComplaintcolumn">{
  ...
  postRequest() {
    ...
    let data = {
      ...
      specificComplaint: this.state.specificComplaint,
    }
          ...
          <div>
            <table>
              <tbody>
                ...
                <tr>
                  <td> <label className="control-margin-lbl"   > Sex: </label></td>
                  <td> <div className="form-check form-check-inline" onChange={this.setSex.bind(this)}>
                ...
                <tr>
                  ...
                  <td> <label className="control-margin-lbl"> What is the profession? </label></td>
                  <td>
                    <div>
                      {/* onload={this.loadProfession.bind(this)}  */}
                ...
                <tr>
                  ...
                  <td> <div id="specialty"><label className={this.state.hideSpecialty ? "hidden" : "control-margin-lbl"}> What is the specialty?</label></div> </td>
                  <div id="specialty2">
                    <td>
            ...
            {/* <MultiForm onSpecCompToParent={this.setReturnValChild} /> */}
            {/* {this.createSpecificComp()} */}
